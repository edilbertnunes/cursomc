...
public class Endereco implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name="fk_cliente_id") // nome do campo da chave estrangeira na tabela endereco
	private Cliente cliente;
	
	@ManyToOne
	@JoinColumn(name="fk_cidade_id") // nome do campo da chave estrangeira na tabela endereco
